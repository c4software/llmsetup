...
source "$SCRIPT_DIR/lib/bench-devices.sh"
source "$SCRIPT_DIR/lib/bench-parallel.sh"
source "$SCRIPT_DIR/lib/bench-cache.sh"
source "$SCRIPT_DIR/lib/bench-load.sh"
source "$SCRIPT_DIR/lib/bench-agentic.sh"
